...
/* harmony import */ var _utils_Accordeon_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/Accordeon.js */ "./src/scripts/utils/Accordeon.js");

var accordeon = document.getElementById('chars-accordeon');

if (accordeon) {
  new _utils_Accordeon_js__WEBPACK_IMPORTED_MODULE_0__.Accordeon(accordeon, {
    isCollapse: true
  });
}
...
/***/ "./src/scripts/modules/pageAnimation.js":
/*!**********************************************!*\
  !*** ./src/scripts/modules/pageAnimation.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var overlay = document.querySelector('.gsap-animate-overlay');
var top = overlay.querySelector('.top');
var middle = overlay.querySelector('.middle');
var bottom = overlay.querySelector('.bottom');
var title = document.querySelector('.intro__content h2');
var text = document.querySelector('.intro__content p');
document.addEventListener('DOMContentLoaded', function () {
  overlay.style.backgroundColor = 'transparent';
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(top, {
    duration: 1,
    delay: 0.6,
    x: '-100vw',
    ease: 'ease-in'
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(middle, {
    duration: 1,
    delay: 0.3,
    x: '100vw',
    ease: 'ease-in'
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(bottom, {
    duration: 1,
    delay: 0.6,
    x: '-100vw',
    ease: 'ease-in'
  ...
  var features = document.querySelectorAll('.features__section-content');

  if (features) {
    features.forEach(function (feature) {
      var text = feature.querySelectorAll('.features-text');
  ...
  var featuresImg = document.querySelectorAll('.features__section-img');

  if (featuresImg) {
    featuresImg.forEach(function (img, i) {
      if (i % 2 === 0) {
  ...
  var charCard = document.querySelectorAll('.char-card');

  if (charCard) {
    charCard.forEach(function (card, i) {
      if (i % 2 === 0) {
  ...
  var question = document.querySelector('.main-footer .feedback h2');
...
function setStickyHeader(bool) {
  if (bool) {
    !header.classList.contains('js-sticky') ? header.classList.add('js-sticky') : null;
  } else {
    header.classList.contains('js-sticky') ? header.classList.remove('js-sticky') : null;
  }
}
...
var onScrollSetWindowScrollY = function onScrollSetWindowScrollY() {
...
var mainSwiper = document.querySelectorAll('.main-swiper');

if (mainSwiper) {
  mainSwiper.forEach(function (slider) {
...
;
var switchers = document.querySelectorAll('.visual__button-group button');
var sliderBoxes = document.querySelectorAll('.visual__slider-box');
...
/***/ "./src/scripts/utils/Accordeon.js":
/*!****************************************!*\
  !*** ./src/scripts/utils/Accordeon.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      this.heads.forEach(function (head) {
        head.addEventListener('click', function (evt) {
          if (_this.isCollapse) {
            ...
            _this.heads.forEach(function (h) {
              h.classList.contains('js-active') ? h.classList.remove('js-active') : null;
            });
          }
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_pageAnimation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/pageAnimation.js */ "./src/scripts/modules/pageAnimation.js");
/* harmony import */ var _modules_stickyHeader_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/stickyHeader.js */ "./src/scripts/modules/stickyHeader.js");
/* harmony import */ var _modules_stickyHeader_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_stickyHeader_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_iMask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/iMask.js */ "./src/scripts/modules/iMask.js");
/* harmony import */ var _modules_accordeon_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/accordeon.js */ "./src/scripts/modules/accordeon.js");
/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modal.js */ "./src/scripts/modules/modal.js");
